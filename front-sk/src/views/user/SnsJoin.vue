        ...
        <div v-if="termPopup" class="terms-doc-dialog">
            <div class="terms">
                ...
                <div class="terms-content">
                    이용약관<br><br>
                    1조.<br>
                    루트립은 귀하의 과한 개인정보를 요구하지 않습니다. 닉네임 등에서 개개인을 특정할 수 있는 정보는 등록하지 말아주십시오.<br>
                    2조.<br>
                    루트립은 저작권 확인을 하지 않습니다. 저작권에 저촉되는 게시물을 올릴 경우 모든 책임은 해당 회원에게 있음을 주의하여 주십시오.<br>
                    3조.<br>
                    루트립은 사익을 목적으로 하는 사이트가 아닙니다. 루트립 내에 이뤄지는 회원들간의 모든 물질적 거래에 대한 책임은 회원에게 있음을 주의하여 주십시오.
                </div>
